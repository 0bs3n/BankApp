#region Auto-generated classes for Banking database on 2017-12-04 17:55:57Z
...
//
// Auto-generated from Banking on 2017-12-04 17:55:57Z
...
public partial class Banking : DbLinq.MySql.MySqlDataContext
{
	public Banking()
	: base(new MySqlConnection(ConfigurationManager.ConnectionStrings["Banking"].ConnectionString))
	{
	}
...
public partial class Transactions : INotifyPropertyChanged
{
	...
	public Transactions(string type, int accountNo, decimal amount, DateTime trans_date)
	{
        this._accountNo = accountNo;
        this._amount = amount;
        this._transType = type;
        this._trAnSdAte = trans_date;
	}
